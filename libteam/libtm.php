...
<body>
	...
	<div class="container-fluid" >
		<div class="navbar-header">
      	    ...
      	    <a class="navbar-brand" href="#"><img alt="Brand" src="img/logo.png" width="75"></a>
        </div>

        <div class="collapse navbar-collapse" id="navigat">
			<ul class="nav navbar-nav">
        		<li class="active"><a href="#">Inicio</a></li>
        		<li><a href="#">Que es LibTm?</a></li>
...
<!--contenedor video-->	
	<div class="container" id="film" >
		<div class="row">
			<div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10  col-lg-10"><h3 align="center">Asi funciona Libteam:</h3></div>

			<div id="vdo" class="col-xs-12  col-sm-12  col-md-12 col-lg-6 col-lg-push-3 well well-sm">
                        <video  controls class="img-responsive">
                            <source src="mov.mp4" type="video/mp4"></source>
                        </video>
			</div><br>	
		</div>	
	</div>
...
<!--contenedor form-->
	<div class="container" id="forml">
		...
		<form class="form-horizontal" action="probar.php" method="POST" >
			...
			<div class="form-group col-xs-12 col-sm-10 col-md-6">
				...
				<div class="input-group col-xs-9 col-sm-8 col-md-9 col-md-push-2 col-lg-push-0 col-xs-push-2 col-sm-push-0" >
					...
					<select class="form-control"  id="formGroup" name="oprdr" required placeholder="Operadora" >
						<option>Seleccione Operador</option>
						<option value="0">Telcel</option>
						<option value="1">Movistar</option>
						<option value="2">Unefon</option>
			...
			<div class="form-group col-xs-12 col-sm-10 col-md-6">
				...
				<div class="input-group col-xs-9 col-sm-8 col-md-9 col-md-push-2 col-lg-push-0 col-xs-push-2 col-sm-push-0" >
					...
					<input class="form-control" type="text" id="formGroup" name="cantid" required placeholder="Numero telefonico" >
				</div>
			...
			<div class="form-group col-xs-12 col-sm-10 col-md-6">
				...
				<div class="input-group col-xs-9 col-sm-8 col-md-9 col-md-push-2 col-lg-push-0 col-xs-push-2 col-sm-push-0" >
					...
					<select class="form-control"  id="formGroup" name="brand" required  placeholder="Marca">
						...
						<option value="11">Sony Xperia</option>
						<option value="12">Vodafone</option>
...
<!--contenedor footer-->
	<div class="container-fluid" id="hea">
		...
		<a title="/josekantun" href="https://www.facebook.com/jose.kantun.56"><img src="img/fb.jpg" alt="face" /></a>
		</div>
		<div class="row"></div>
